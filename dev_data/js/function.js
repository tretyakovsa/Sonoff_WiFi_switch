        ...
        for(i = 0;i<jsonPage.content.length;i++) {
         if (!jsonPage.content[i].module || searchModule(jsonResponse.module,jsonPage.content[i].module)=='yes') {
          ...
          if (type_val == 'dev') {
           ...
           dev_html += jsonResponse.LangType+': <div class="btn-group"><select class="btn btn-default btn-sx" onchange="send_request(this, \'/configs?set=\'+this.value,\'\')"><option value="RGB">Select Please<\/option><option value="Sonoff-rf">Sonoff-rf / Sonoff / Wi-Fi Smart socket<\/option><option value="RGB">RGB (WS2811-12/NeoPixel)<\/option><option value="Jalousie">Jalousie<\/option><option value="Leakag">Leakag<\/option><option value="Smart-Room">Smart-Room<\/option><\/select> <a href="/page.htm?config.modules" target="_blank" class="btn btn-primary">Edit<\/a><\/div>';
